...
import { DailyEntries, daily_entries } from './schema';
...
// Insert entry
export const insertDailyEntries = async (entry: Omit<DailyEntries, 'id'>): Promise<void> => {
...
// Update entry
export const updateDailyEntriesInDb = async (id: number, data: Partial<Omit<DailyEntries, 'id'>>): Promise<void> => {
